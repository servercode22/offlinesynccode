...
class SyncApiController extends Controller
{
    ...
    public function businessRegValidate(request $request)
    {
        ...
        // $live_server_path = "http://localhost/main-sync-api/public/connector/api/";
        $live_server_path = "http://127.0.0.1:8000/connector/api/";
            ...
            if ($request->getStatusCode() == 200) {
                ...
                foreach ($response as $role) {
                    ...
                    foreach ($role->role_has_permissions as $mhp) {
                        DB::table('role_has_permissions')->updateOrInsert(['role_id' => $mhp->role_id, 'permission_id' => $mhp->permission_id], (array) $mhp);
                    }
                }
            } else {
                dd([$response, 15]);
    ...
    public function syncSale()
    {
        ...
        if ($check_cash_status_count > 0) {
            ...
            $url = "http://localhost/main-sync-api/public/api/";
            $http = new Client(['base_uri' => $url, 'debug' => true]);
            ...
            $salesTables =  ['contacts', 'transactions', 'transaction_payments', 'transaction_sell_lines', 'cash_registers', 'cash_register_transactions'];
            ...
            foreach ($salesTables as $salesTable) {
                ...
                if (
                    ...
                    // dd($json = [$salesTable => $get_sale_table_records]);
...
// $url = "http://localhost/main_pos_2/public/api/";
// $http = new Client;
// $request = $http->post(
//     $url . 'sales-upload',
//     [
...
//             'grant_type' => 'password',
//             'client_id' => '1',
//             'client_secret' => 'BzJLj5hmK4uLR2ev666HvUfo53lq6pGKJyqKyGzl',
//             'username' => 'local',
//             'password' => '12345',
//             'scope' => 'hello',
//         ],
