...
class ProductUtil extends Util
{
    ...
    //hamza code productposadd
    public function createSingleProductVariationpos($product, $sku, $purchase_price, $dpp_inc_tax, $profit_percent, $selling_price, $selling_price_inc_tax, $combo_variations = [])
    {
...
//productposend
    ...
    public function updateVariableProductVariations($product_id, $input_variations_edit)
    {
        ...
        foreach ($input_variations_edit as $key => $value) {
            ...
            $product_variation->sync_status = 0;
