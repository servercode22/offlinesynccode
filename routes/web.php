...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('test-api', 'SyncApiController@test');

    Route::get('test-product-api', 'SyncApiController@productSync');


    // Sync Tables
    // Route::get('sync-get-live-products-data', 'SyncController@getLiveProductsData');



    // Route::get('sync-new', 'SyncController@syncSellPosSaleModuleOnly'); // using api syncSale, SyncApiController@syncSale

    // Route::get('sync-cash', 'SyncController@syncSellPosSaleModuleOnlyCash');
    // Route::get('sync', 'SyncController@syncTables');
    // Route::get('sync_sell', 'SyncController@syncSalesModuleTables');
    // Route::get('syncb', 'SyncController@syncTablesB');
    // Route::get('sync_test', 'SyncController@syncSalesModuleTablesTest');


    Route::post('productposstore' , 'SellPosController@productposstore')->name('pos.productposstore');
...
Route::post('/business/register', 'SyncApiController@businessRegValidate')->name('business.postRegister');

Route::middleware(['auth'])->group(
    function () {

        Route::get('/sync-new', 'SyncApiController@syncSale');
        Route::get('sync-get-live-products-data', 'SyncApiController@getLiveProductsData');

        // Test Session
        Route::get('test-sess', 'SellPosController@test_session');
    }
);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/onlylocalsycpos/check-mobile', 'ContactController@checkMobile');
