  ...
  <div class="row">
    ...
    <div class="col-md-6">
      {{-- <a href="{{$go_back_url}}" title="{{ __('lang_v1.go_back') }}" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        ...
        <a href="{{action('Auth\LoginController@logout')}}" class="btn btn-warning btn-flat  pull-right"><span class="glyphicon glyphicon-log-out"></span>&nbsp;@lang('lang_v1.sign_out')</a>
