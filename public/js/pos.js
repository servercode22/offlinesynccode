    ...
    $('form#quick_add_contact')
        ...
        .validate({
            ...
            submitHandler: function(form) {
                $.ajax({
                    method: 'POST',
                    url: '/onlylocalsycpos/check-mobile',
                    dataType: 'json',
                    data: {
                        contact_id: function() {
                            return $('#hidden_id').val();
...
$('#save_product').on('submit' , function(e){
    var data = $(this).serialize();
    e.preventDefault();
    $.ajax({
        method : 'POST',
        url: $('#save_product').attr('action'),
        data: data,
        success:function(result){
            ...
            if(result.success == true){
                ...
                toastr.success(result.msg);
                $('#save_product').trigger("reset");
                $('#save_product select').trigger("change"); //Line2
